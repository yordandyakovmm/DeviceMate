    ...
    public class WindsorConfig : IWindsorInstaller
    {
        ...
        public static string AssemblyDirectory
        {
            get
            {
                ...
                return Path.GetDirectoryName(path.AbsolutePath);
            }
        }
        ...
        public static AssemblyFilter Filter
        {
            get
            {
                return new AssemblyFilter(AssemblyDirectory).FilterByName(name => name.Name.StartsWith(DMC.Common.ApplicationBusinessLibrariesPrefix));
            }
        }
        #endregion
